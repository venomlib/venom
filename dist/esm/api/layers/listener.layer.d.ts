...
import { Ack, Chat, LiveLocation, Message, Reaction, ParticipantEvent, PicTumb, ChatStatus } from '../model/index.js';
...
export declare class ListenerLayer extends ProfileLayer {
     ...
     * @param fn
     */
    onMessageEdit(fn: (message: Message) => void): Promise<{
        dispose: () => void;
    }>;
    /**
     ...
     * @param fn
     */
    onMessageDelete(fn: (message: Message) => void): Promise<{
        dispose: () => void;
    }>;
    /**
     ...
     * @param fn
     */
    onMessageReaction(fn: (reaction: Reaction) => void): Promise<{
        dispose: () => void;
    }>;
    /**
