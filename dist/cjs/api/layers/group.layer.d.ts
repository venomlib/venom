...
export declare class GroupLayer extends RetrieverLayer {
     ...
     */
    getAllChatsGroups(): Promise<import("../model/chat.js").Chat[]>;
    /**
     * Retrieve all groups new messages
     * @returns array of groups
     */
    getChatGroupNewMsg(): Promise<import("../model/chat.js").Chat[]>;
    /**
     ...
     */
    createGroup(groupName: string, contacts: string | string[]): Promise<import("../model/group-creation.js").GroupCreation>;
    /**
